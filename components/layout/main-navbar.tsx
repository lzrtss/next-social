...
export default function MainNavbar({ links }: MainNavbarProps) {
  return (
    <aside className="py-4 fixed bottom-0 w-full z-10 custom-scrollbar bg-neutral-800 border-t border-t-neutral-700 md:sticky md:left-0 md:top-0 md:min-h-screen md:w-fit md:flex-col md:overflow-auto md:border-t-0 md:border-r md:border-r-neutral-700">
      <nav>
