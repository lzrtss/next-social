...
export default function CommunitiesNavbar() {
  return (
    <aside
      className="hidden xl:sticky right-0 top-0 h-screen w-fit z-10 overflow-auto custom-scrollbar border-l border-l-neutral-700 bg-bg-neutral-800 max-xl:hidden;
  "
    >
